...
describe("follow", function () {
  ...
  it("returns the expected results from Louden fixtures", function () {
    assert.deepStrictEqual(
      new Grammar(Fixtures.expressions).calculations.follow,
      new Relation([
        ["exp", END],
        ["exp", "+"],
        ["exp", "-"],
    ...
    assert.deepStrictEqual(
      new Grammar(Fixtures.ifelse).calculations.follow,
      new Relation([
        ["statement", END],
        ["statement", "else"],
        ["exp", ")"],
    ...
    assert.deepStrictEqual(
      new Grammar(Fixtures.statements).calculations.follow,
      new Relation([
        ["stmt-sequence", END],
        ["stmt", ";"],
        ["stmt", END],
