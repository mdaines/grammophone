import {
  getURLSearchParamSpec,
  encode,
  decode
} from "../../src/app/spec_links.js";
...
describe("getURLSearchParamSpec", function () {
  ...
  it("returns the expected spec for a search param with a plus sign", function () {
    const search =
      "s=UyAtPiBTdGFydCAkLgpTdGFydCAtPiBUeXBlIE5hbWUuClN0YXJ0IC0+IE5hbWUuClR5cGUgLT4gaWQgIjwiLgpOYW1lIC0+IGlkICI8Ii4=";
    const expected =
      'S -> Start $.\nStart -> Type Name.\nStart -> Name.\nType -> id "<".\nName -> id "<".';
...
describe("encode", function () {
  ...
  it("handles characters outside of ASCII range", function () {
    assert.deepStrictEqual(
      encode('"音楽" -> "♫" "音楽" | .'),
      "Iumfs+alvSIgLT4gIuKZqyIgIumfs+alvSIgfCAu"
    );
  });
});
...
describe("decode", function () {
  it("handles characters outside of ASCII range", function () {
    assert.deepStrictEqual(
      decode("Iumfs+alvSIgLT4gIuKZqyIgIumfs+alvSIgfCAu"),
      '"音楽" -> "♫" "音楽" | .'
    );
  });
});
